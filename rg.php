...
<div class="container">
  <div class="row" style="margin-top:10px">
    <div class="col-xs-12 col-sm-6 col-md-6 col-sm-offset-2 col-md-offset-3">
      <form name="form_login" method="post" action="rg.php" role="form">
        <fieldset>
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
              <input type="submit" name="register_btn" value="Register" class="btn btn-lg btn-success btn-block">
            </div>
              <div class="col-xs-6 col-sm-6 col-md-6">
      Already a member? <a href="lg.php"><font color="blue">Login</font></a>
    </div>
        </fieldset>
      </form>
    </div>
