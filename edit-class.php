...
$sql="update  tblclasses set ClassName=:classname,ClassNameNumeric=:classnamenumeric,Term=:Term where id=:cid ";
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Update pupils Class</h2>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Update pupils Class info</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                     ...
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label">Term</label>
                                                        <div class="">
                                                            <input type="text" name="Term" value="<?php echo htmlentities($result->Term);?>" class="form-control" required="required" id="success">
