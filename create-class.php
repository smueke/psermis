...
$term=$_POST['term'];
$sql="INSERT INTO  tblclasses(ClassName,ClassNameNumeric,Term) VALUES(:classname,:classnamenumeric,:term)";
...
<html lang="en">
    <head>
        ...
        <title>PSERMIS Admin Create Class</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h3 class="title">Create Pupil's Class</h3>
                                </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="number" name="term" required="required" class="form-control" id="success">
